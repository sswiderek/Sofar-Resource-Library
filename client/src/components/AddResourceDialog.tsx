        ...
        <div className="py-4 space-y-4">
          ...
          <div className="rounded-lg border border-amber-100 bg-amber-50 p-3 text-sm">
            <p className="text-amber-800 font-medium flex items-center">
              ...
              <span>Currently only supports webpage URLs</span>
            </p>
            <p className="text-amber-700 text-xs mt-1 ml-6">This tool does not yet support PDFs, YouTube videos, or other non-webpage content</p>
          </div>
